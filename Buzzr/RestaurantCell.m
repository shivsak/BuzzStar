...
@synthesize cellView, cellCustomerName, cellCustomerTableFor, cellCustomerPhoneNumber;
...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated
{
    ...
    if (self.highlighted) {
        ...
        [self.cellCustomerName pop_addAnimation:scaleAnimation forKey:@"scalingUp"];
        ...
        [self.cellCustomerName pop_addAnimation:sprintAnimation forKey:@"springAnimation"];
    }
}
