...
@synthesize cellView, cellRestaurantName, cellQueue;
...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated
{
    ...
    if (self.highlighted) {
        ...
        [self.cellRestaurantName pop_addAnimation:scaleAnimation forKey:@"scalingUp"];
        ...
        [self.cellRestaurantName pop_addAnimation:sprintAnimation forKey:@"springAnimation"];
    }
}
